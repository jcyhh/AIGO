...
test('icon component provides a local inline svg icon contract', async () => {
    ...
    assert.doesNotMatch(component, /size\?:/)
    assert.doesNotMatch(component, /color\?:/)
    assert.match(showcasePage, /size-32 app-color/)
    assert.match(showcasePage, /size-44 blue/)
