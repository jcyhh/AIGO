...
test('popup exposes the template base popup contract', async () => {
    ...
    assert.match(component, /contentTheme = 'default'/)
    assert.match(component, /contentTheme\?:\s*PopupContentTheme/)
    ...
    assert.match(component, /theme=\{contentTheme\}/)
    ...
    assert.match(readme, /contentTheme/)
    assert.match(readme, /gradient-card/)
